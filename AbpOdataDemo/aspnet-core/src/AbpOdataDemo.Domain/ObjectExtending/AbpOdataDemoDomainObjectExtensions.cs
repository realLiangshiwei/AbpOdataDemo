...
namespace AbpOdataDemo.ObjectExtending
{
    public static class AbpOdataDemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpOdataDemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
